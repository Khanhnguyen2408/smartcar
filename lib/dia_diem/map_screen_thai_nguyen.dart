...
class _MapScreenState extends State<MapScreen3> {
  ...
  double _destLatitude = 21.6046362, _destLongitude = 105.819159;
          ...
          children: [
            Positioned.fill(
              child: GoogleMap(
                ...
                initialCameraPosition: MapScreen3._initialCameraPosition,
...
final databaseReference = FirebaseDatabase.instance.ref("Thai Nguyen");
